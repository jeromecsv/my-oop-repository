        ...
        do {     // repetition of selection of operation to be perform
            ...
            switch (input) {
                ...
                case 4:
                    tableSorting();
                case -1:
                    Operation acctCreation = new Operation();
                    acctCreation.accountCreation();
                    break;
        ...
        do {
            ...
            switch (input) {
                ...
                case 2:
                    ...
                    List<Transaction> sortedList1 = transactionArray.stream()
                ...
                case 3:
                    ...
                    break;
                case -1:
                    Operation acctTransaction = new Operation();
                    acctTransaction.selectTransaction();
                    break;
                default:
